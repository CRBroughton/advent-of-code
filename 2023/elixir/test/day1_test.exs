defmodule Day1Test do
  ...
  test "Sanitizes the input" do
    ...
    assert Day1.sanitizeRounds(input) == ["1abc2", "pqr3stu8vwx", "a1b2c3d4e5f", "treb7uchet"]
  end

  test "Read through a single line, splitting in a list" do
    input = "a1b2c3d4e5f"

    assert Day1.splitStringToChars(input) == ["a", "1", "b", "2", "c", "3", "d", "4", "e", "5", "f"]
  end

  test "Gets the pair of numbers " do
    input = ["a", "1", "b", "2", "c", "3", "d", "4", "e", "5", "f"]

    assert Day1.getPairOfNumbers(input) == 15
  end

  test "Sum the numbers of a list" do
    input = """
    threehqv2
    ...
    assert Day1.sumTheValues(input) == 54388
  end

  test "Returns a integer of a represtational string value" do
    assert Day1.matchStringToInt("eight") == 8
  end

  test "Returns the sum value" do
    input = "sxoneightoneckk9ldctxxnffqnzmjqvj"
    assert Day1.sumTheSingleStringValues(input) == 19
  end

  test "Sums up the test data string values" do
    input = """
    threehqv2
    sxoneightoneckk9ldctxxnffqnzmjqvj
    1hggcqcstgpmg26lzxtltcgg
    ...
    """
    assert Day1.sumTheStringValues(input) == 53515
  end
end
